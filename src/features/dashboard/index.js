...
import ModalQRCodeout from './Modalcreat/ModalQRCodeout';
...
function Dashboard() {
    ...
    const [showModalQRCode2, setShowModalQRCode2] = useState(false);
    ...
    const handleQRCode2 = (item, eventID) => {
        setQrEventID(eventID);
        setSelectedUserDetails(item);
        setShowModalQRCode2(true);
    };
                        ...
                        <td>
                            <div className="flex justify-center gap-2 items-center">
                                <button
                                    ...
                                    className='cursor-pointer hover:bg-gray-300 bg-green-300 rounded-md'
                                >
